...
impl<'mm, 'db> Environment<'mm, 'db> {
    ...
    pub fn load_records_from_db<Mode: IdMode>(
        &mut self,
        model_name: &str,
        ids: &Mode,
    ) -> Result<()> {
    ...
    pub fn load_records_fields_from_db<Mode: IdMode>(
        &mut self,
        model_name: &str,
        ids: &Mode,
        fields: &[&str],
    ...
    pub fn get_dirty_stored_records(
        &self,
        model_name: &str,
        ids: &[u32],
    ...
    pub fn get_dirty_filtered_records<F>(
        &self,
        model_name: &str,
        ids: &[u32],
        field_filter: F,
    ...
    pub fn ensure_fields_in_cache<Mode: IdMode>(
        &mut self,
        model_name: &str,
        field_name: &str,
        ids: &Mode,
    ...
    pub fn save_value_to_cache<Mode: IdMode, E>(
        &mut self,
        model_name: &str,
        field_name: &str,
        ids: &Mode,
    ...
    pub fn save_option_to_cache<Mode: IdMode, E>(
        &mut self,
        model_name: &str,
        field_name: &str,
        ids: &Mode,
